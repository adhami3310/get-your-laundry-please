...
app.get('/heart_broken.svg', (request, response) => {
    response.sendFile(path_1.default.join(__dirname, '../public/heart_broken.svg'));
});
app.get('/mail.svg', (request, response) => {
    response.sendFile(path_1.default.join(__dirname, '../public/mail.svg'));
});
app.get('/check.svg', (request, response) => {
    response.sendFile(path_1.default.join(__dirname, '../public/check.svg'));
});
app.get('/question.svg', (request, response) => {
    response.sendFile(path_1.default.join(__dirname, '../public/question.svg'));
});
